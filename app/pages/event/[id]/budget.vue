    ...
    <div>
      ...
      <UiCard class="mb-6 p-6">
        <div class="flex justify-between items-center mb-3">
          <span class="text-sm text-text-secondary">{{ t.budget_progress }}</span>
        ...
        <div class="flex justify-between items-end mt-2">
          <div>
            <div class="text-xs text-text-secondary mb-1">{{ t.used }}</div>
            <div class="text-xl font-bold text-text-primary">฿{{ formatMoney(used) }}</div>
          </div>
          <div class="text-right">
            <div class="text-xs text-text-secondary mb-1">{{ t.remaining }}</div>
            <div 
      ...
      <UiCard class="p-6">
        <h3 class="text-xl font-bold text-text-primary mb-5">{{ t.expenses_by_category }}</h3>
